  ...
  return (
    <div className="flex p-5 flex-col space-y-10 h-full w-full items-center justify-center">
      ...
      <div className="flex flex-col w-full sm:w-3/4 md:w-1/2 lg:w-1/3 space-y-4">
        ...
        <div className="flex items-center space-x-2 justify-center hover:bg-gray-800 hover:text-gray-200 text-sm p-2 rounded-md bg-gray-900 text-gray-400 hover:cursor-pointer">
